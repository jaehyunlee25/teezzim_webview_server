const clubId = '25a74f6f-e3d3-11ec-a93e-0242ac11000a';
const courses = { 
	'서코스': '4d4146f3-e3d3-11ec-a93e-0242ac11000a',
	'동코스': '4d41493e-e3d3-11ec-a93e-0242ac11000a',
};
	...
	post('reservation_01.asp', param, {}, data => {
		...
		Array.from(arrDiv).forEach((div, i) => {			
			...
			Array.from(trs).forEach(tr => {
				...
				const fee_discount = tr.children[1].innerText.replace(/\s/g,"").ct(1).split(',').join('') * 1;
				const fee_normal = tr.children[1].innerText.replace(/\s/g,"").ct(1).split(',').join('') * 1;
