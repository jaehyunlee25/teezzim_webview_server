const clubId = "5d8163d1-cd85-11ec-a93e-0242ac11000a";
const courses = {
  OUT: "b81cbf25-cd86-11ec-a93e-0242ac11000a",
  IN: "b81cc15a-cd86-11ec-a93e-0242ac11000a",
};
...
function procDate() {
  ...
  const timer = setInterval(() => {
    ...
    console.log("수집하기", cnt + "/" + lmt, arrDate);
