javascript: (() => {
  ...
  const dict = {
    ...
    "https://paganica.kmhleisure.com/Mobile/Reservation/ReservationCheck.aspx": funcExec,
  };
  ...
  function funcReserve() {
    ...
    location.href = "/Mobile/Reservation/ReservationTimeList.aspx?strReserveDate=" + fulldate + "&strGolfLgubun=120";
  }
  function funcTime() {
    log("funcTime");
